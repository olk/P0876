...
applicability of fibers and requires a internal global variable pointing to
\main.}
...
fiber. This allows to pass the active fiber \cpp{m} (for instance representing
\main) into the fiber \cpp{l} via lambda capture. This mechanism enables to
...
\cpp{fiber::current()} allows to construct multiple instance of \fiber for the
...
counted global variable and does not prevent accidentally resuming the active
fiber.}
