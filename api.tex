...
{\bfseries Return value}
\begin{description}
    \item[fiber\&] reference to \cpp{*this} representing the fiber that was
...
\begin{description}
    \item[1)] \cpp{*this} is internally replaced by the fiber that has resumed
            the current fiber
\end{description}
...
When calling \resume, \cpp{*this} -- the instance on which \resume was called --
