...
\precond
\cpp{stack} must have implementation-defined alignment and minimum size.
...
\effects
Equivalent to: \cpp{this->state = move(other.state)}.

\postcond
\cpp{other.}\emptyfn returns \true.
