...
At the moment of resumption, the running fiber can be in either of two states, as follows.

\begin{description}
    \item[---]
          If the running fiber has already been entered, that implies that
          at some earlier time, it suspended itself by
          ...
          where \cpp{before} is a \fiber object, denote
