...
between \resumewith and \xtresumewith, is both for potential runtime
...
\requires
\begin{description}
    \item[---] \cpp{empty()} would return \cpp{true}, or
    \item[---] the fiber referenced by \cpp{*this} is explicit,
               and \canxtresume would return \cpp{true}
\end{description}
...
\begin{description}
    \item[---] \cpp{empty()} would return \cpp{true}, or
    \item[---] the fiber referenced by \cpp{*this} is explicit,
               and \canresume would return \cpp{true}
\end{description}
