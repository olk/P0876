...
thread's \entryfn\xspace to be represented as fibers.
A \fiber representing \main or a thread's \entryfn\xspace
can be handled like an explicitly created \fiber: it can passed to and returned
from functions or stored in a container. When called on such an
instance, \usessysstack returns \cpp{true}.\\
