...
\begin{itemize}
    ...
    \item In [intro.fibers] former paragraph 3, use expositional names for the
          current fiber and the target fiber to clarify.
    \item \null [fiber.context.pre] is now ``Overview'' instead of ``Preamble''.
    \item Merge [fiber.context.syn] into [fiber.context.class].
    \item Make default \fiber constructor and move constructor \cpp{= default}.
