...
The \cancelfn / \cancel mechanism is a minor convenience, providing a way for
...
Running fiber M calls \cpp{f1.cancel()}, which returns another \fiber
instance \cpp{f2}.
...
possible way to use the \cancelfn / \cancel mechanism.
