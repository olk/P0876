...
\cpp{std::fiber\_context&&} and return \fiber. The \fiber instance returned by \cpp{fn()}
...
\zs{Member function \resumewith allows you to inject a function into a suspended
fiber.}
