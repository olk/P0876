...
%% this makes green text on white background, and supports multiple lines:
%% \newcommand{\add}[1]{{\color{green}#1}}
%% this makes black text on green background, but forces all contents to a
%% single line:
...
\newcommand{\stdname}[2]{\stdterm{\cpp{#1}}{#2}}
