...
\newcommand{\params}{\emph{Parameters:}\xspace}
\newcommand{\requires}{\emph{Requires:}\xspace}
\newcommand{\remarks}{\emph{Remarks:}\xspace}
\newcommand{\effects}{\emph{Effects:}\xspace}
\newcommand{\returns}{\emph{Returns:}\xspace}
\newcommand{\postcond}{\emph{Postconditions:}\xspace}
\newcommand{\except}{\emph{Exceptions:}\xspace}
