...
\newcommand{\someresume}{\resume}
\newcommand{\someresumewith}{\resumewith}
\newcommand{\resumesome}{\resume or \resumewith}
\newcommand{\xtresumesome}{\xtresume or \xtresumewith}
\newcommand{\allresume}{\resume or \resumewith}
...
\newcommand{\seeappalaunch}{(See \nameref{appendixa} for the definitions of \cpp{launch()} and \cpp{autocancel}.)}
\newcommand{\seeappaassert}{(See \nameref{appendixa} for the definition of \cpp{assert_on_cancel}.)}
